...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_dir', type=str, default="1015/i2v_anchorcrafter_81f_rope_mochu_sft_selfswap_ff_sft",
    ...
    parser.add_argument('--is_fl', action='store_true',
                        help="Use first-last frame mode for dataset")
