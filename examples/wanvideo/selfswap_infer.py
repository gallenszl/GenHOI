...
from examples.wanvideo.dataset.customer_dataset_anchorcrafter import HumanHoiDataset_anchorcrafter
...
def run_inference_multi(output_dir, data_csv, max_num_frames, is_fl, model_path, lora_path, devices: List[int] = None):
    ...
    dataset = HumanHoiDataset_anchorcrafter(
        data_dir=data_csv,
        video_size=(1280, 720),
        fps=25,
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Run selfswap video inference with multi-GPU")
    parser.add_argument('--output_dir', type=str, default="results/selfswap",
                        help="Output directory for generated videos")
    parser.add_argument('--data_csv', type=str, default="/root/paddlejob/workspace/huangxuan/AnchorCrafter-400_405f/dataset_select.csv",
                        help="Path to the dataset CSV file")
    parser.add_argument('--gpus', type=str, default="0,1,2,3",
                        help="Comma-separated list of GPU indices to use (e.g., '0,1,2,3')")
    parser.add_argument('--max_num_frames', type=int, default=401,
...
#     --data_csv data/anchorcrafter/dataset_select.csv \
#     --gpus 0,1,2,3 \
#     --max_num_frames 81
...
# python examples/wanvideo/selfswap_infer.py \
#     --output_dir results/selfswap_81_vace_flf \
