...
def launch_training_task(
    ...
    dataloader = torch.utils.data.DataLoader(dataset, shuffle=True, collate_fn=lambda x: x[0], num_workers=num_workers, prefetch_factor=2)
...
def wan_parser():
    ...
    parser.add_argument("--vace_model_path", type=str, default=None, help="Paths to load vace model.")
