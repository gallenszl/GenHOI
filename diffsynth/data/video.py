...
def save_video(frames, save_path, fps, quality=10, ffmpeg_params=None):
...
def save_video_zheluntest(frames, save_path, fps, quality=10, ffmpeg_params=None):
    if ffmpeg_params is None:
        ffmpeg_params = [
            "-crf", "0",          # 0表示无损画质（越小越清晰）
            "-preset", "veryslow",# 更好的压缩率（耗时更多）
